...
public class ListItemRequestOutFullTable {

    public ListItemRequestOutFullTable() {
    }
    ...
    public ListItemRequestOutFullTable(String ID, String kode_MO, String kode_Proyek, String kode_Item, String volume, String unit, String work_Code, String kode_Tower, String kode_Lantai, String kode_Zona, String courierPhoto, String refHeaderSPR, String refDetailSPR, String statusRequest, String approvalNo, String statusAktif, String nama_Pembuat, String tanggal_Dibuat, String nama_Pengubah, String tanggal_Diubah, String comment, String nama_Kurir, String deskripsi, String nama_Tower, String nama_Lantai, String nama_Zona) {
        this.ID = ID;
        Kode_MO = kode_MO;
        Kode_Proyek = kode_Proyek;
        Kode_Item = kode_Item;
