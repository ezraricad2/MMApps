package com.totalbp.mm.fragments;
...
public class ProfilePictureDialogFragment extends DialogFragment {
    private String TAG = ProfilePictureDialogFragment.class.getSimpleName();
   ...
   public static ProfilePictureDialogFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        linkimages =  getArguments().getString("images");
...
//        lblDate.setText(image.getTimestamp());
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            Glide.with(getActivity()).load(linkimages)
                    //.thumbnail(0.5f)
                    .crossFade()
